# Angular 4 CRUD table using REST backend

Simple CRUD table component for Angular 4 using REST backend and Bootstrap 3 CSS. (<a target="_blank" href="https://mazdik.github.io/ng2-crud-table/">Demo</a>)  
