...
import {Item, PrimeItem} from './shop';
...
export class ShopComponent implements OnInit {
  ...
  public columns:Array<any> = [
    ...
    {title: 'Type', name: 'type', sort: '', filtering: {filterString: ''}},
    {title: 'Pic', name: 'pic', sort: '', filtering: {filterString: ''}},
    {title: 'Item_name.', name: 'item_name', sort: '', filtering: {filterString: ''}},
    {title: 'Description', name: 'description', sort: '', filtering: {filterString: ''}},
    {title: 'Price', name: 'price', sort: '', filtering: {filterString: ''}},
    {title: 'Status', name: 'status', sort: '', filtering: {filterString: ''}},
  ];
  ...
  constructor(private service:ShopService, private loadingService:LoadingService) {
  }
